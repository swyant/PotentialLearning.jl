...
#ds, thermo = ds[220:420], thermo[220:420];
...
local_descriptors = JLD.load("./examples/Sodium/data/sodium_local_descriptors.jld", "descriptors");

# If we need to compute local descriptors
# local_descriptors = compute_local_descriptors.(systems, (ace,));
# JLD.save("./examples/Sodium/data/sodium_local_descriptors.jld", "local_descriptors", local_descriptors)
